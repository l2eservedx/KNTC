...
Packetx::Packetx(int cID, int clength, char* ccontent, e_PacketType cpacketType) {
    ID = cID;
    length = clength;
    content = ccontent;
...
int Packetx::getLength() {
    return length;
}

char* Packetx::getContent() {
    return content;
}

e_PacketType Packetx::getPacketType() {
    return packetType;
}

void Packetx::printPacket(bool debug) {
    // console string
    std::string pck_type;
